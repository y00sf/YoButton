...
namespace Yosf.UI
{
    public class YoButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        ...
        [Header("Effects")]
        [HideInInspector] public string[] effectType = { "ScaleEffect", "ColorEffect" };
        ...
        public void UpdateGraphicTarget()
        {
            ...
            // If the graphic target has changed, update the current graphic target
            currentGraphicTarget = GraphicTarget;
            ApplyTheme(); // Apply the theme to the new graphic target
        }
